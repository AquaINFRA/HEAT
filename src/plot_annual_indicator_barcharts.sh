...
in_wk3_path="../testoutputs/AnnualIndicators${assessmentPeriod}.csv"
...
# Run R script:
echo "Running plot_annual_indicator_barcharts.R for assessment period "${assessmentPeriod}
Rscript --vanilla plot_annual_indicator_barcharts.R $assessmentPeriod $in_wk3_path $in_unitsFilePath $in_configIndicatorsFilePath $out_plotsPath
