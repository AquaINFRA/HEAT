...
in_wk5_path="../testoutputs/AssessmentIndicators${assessmentPeriod}.csv"
in_configIndicatorsFilePath="../Input/${assessmentPeriod}/Configuration${assessmentPeriod}.xlsx"
...
# Run R script:
echo "Running plot_assessment_indicator_maps.R for assessment period "${assessmentPeriod}
Rscript --vanilla plot_assessment_indicator_maps.R $assessmentPeriod $in_wk5_path $in_unitsFilePath $in_configIndicatorsFilePath $out_plotsPath
