...
Rscript --vanilla run_heat3_csv.R $input_dir $in_relevantStationSamplesPath $in_unitsCleanedFilePath $in_configIndicatorsFilePath $in_configIndicatorUnitsFilePath $in_configIndicatorUnitResultsFilePath $in_combined_Chlorophylla_IsWeighted $out_AnnualIndicatorPath