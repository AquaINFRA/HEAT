...
'''
curl -X POST "http://localhost:5000/processes/heat_2_holas/execution" -H "Content-Type: application/json" -d "{\"inputs\":{\"assessment_period\": \"2016-2021\"}}"

curl -X POST "http://localhost:5000/processes/heat_2_holas/execution" -H "Content-Type: application/json" -d "{\"inputs\":{\"assessment_period\": \"2016-2021\", \"bottle_data\": \"https://testserver.com/download/f2369468-30f8-4add-8a5d-25cf768f5096.csv\"}}"
...
class HEAT2HolasProcessor(BaseProcessor):
    ...
    def __repr__(self):
        return f'<HEAT2HolasProcessor> {self.name}'
