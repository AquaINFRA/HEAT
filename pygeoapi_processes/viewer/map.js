...
const jobId = params.get('job_id') || '236a1ca8-56bb-11f0-bf80-fa163e42fba0'; // fallback if no parameter is given
const processId = params.get('process_id')
//const geojsonFilename = 'units_gridded-'+jobId+'.json';
const fileNameBase = params.get('filebase') || 'units_gridded'
//const geojsonFilename = 'units_gridded-'+jobId+'.json';
//const geojsonFilename = 'StationSamples-'+jobId+'.json';
