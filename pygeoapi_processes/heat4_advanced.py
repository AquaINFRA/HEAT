...
# Tested 2025-10-12
curl -X POST https://${PYSERVER}/processes/heat4advanced/execution \
--header 'Content-Type: application/json' \
--data '{
    "inputs": {
        "annual_indicators": "https://aquainfra.ogc.igb-berlin.de/exampledata/helcom/dummy/AnnualIndicators_20251012.csv",
