...
'''
curl -X POST "https://localhost:5000/processes/heat_3/execution" -H "Content-Type: application/json" -d "{\"inputs\":{\"assessment_period\": \"2016-2021\", \"combined_Chlorophylla_IsWeighted\": true, \"station_samples\": \"https://testserver.com/download/StationSamples-f04c9a56-838a-11ef-8e41-e14810fdd7f8.csv\"}}"
